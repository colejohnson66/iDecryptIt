...
namespace Hexware.Plist
{
    ...
    {
        /// <summary>
        /// Hexware.Plist.PlistFill constructor using a path
        /// </summary>
        ...
        public PlistFill(string path, IPlistElement parent)
        {
            if (path == null)
            {
    ...
    public partial class PlistFill
    {
        ...
        /// <param name="parent">A reference to the parent element of this element</param>
        /// <returns>The <see cref="Hexware.Plist.PlistFill"/> element from the binary stream</returns>
        internal static PlistFill ReadBinary(BinaryReader reader, byte firstbyte, string path, IPlistElement parent)
        {
            return new PlistFill(path, parent);
        }
        ...
        /// <param name="path">The path of this node</param>
        /// <param name="parent">A reference to the parent element of this element</param>
        /// <returns>The <see cref="Hexware.Plist.PlistFill"/> element from the Xml stream</returns>
        internal static PlistFill ReadXml(XmlDocument reader, int index, string path, IPlistElement parent)
        {
            return new PlistFill(path, parent);
        }
    ...
    public partial class PlistFill : IDisposable
    {
