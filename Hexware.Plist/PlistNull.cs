...
namespace Hexware.Plist
{
    ...
    public partial class PlistNull
    {
        ...
        public PlistNull(string path, IPlistElement parent)
        {
            if (path == null)
            {
    ...
    public partial class PlistNull
    {
        ...
        /// <param name="parent">A reference to the parent element of this element</param>
        /// <returns>The <see cref="Hexware.Plist.PlistNull"/> element from the binary stream</returns>
        internal static PlistNull ReadBinary(BinaryReader reader, byte firstbyte, string path, IPlistElement parent)
        {
            return new PlistNull(path, parent);
        }
        ...
        /// <param name="path">The path of this node</param>
        /// <param name="parent">A reference to the parent element of this element</param>
        /// <returns>The <see cref="Hexware.Plist.PlistNull"/> element from the Xml stream</returns>
        internal static PlistNull ReadXml(XmlDocument reader, int index, string path, IPlistElement parent)
        {
            return new PlistNull(path, parent);
        }
    ...
    public partial class PlistNull : IDisposable
    {
