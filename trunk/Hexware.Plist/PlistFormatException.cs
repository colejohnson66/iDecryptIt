...
namespace Hexware.Plist
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the Hexware.Plist.PlistFormatException class with default parameters.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the Hexware.Plist.PlistFormatException class with a specified error message.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the Hexware.Plist.PlistFormatException class with a specified error message and a reference to the inner exception that is the cause of this exception.
        /// </summary>
        /// <param name="message">The error message that explains the reason for the exception.</param>
        ...
        /// <summary>
        /// Initializes a new instance of the Hexware.Plist.PlistFormatException class with serialized data.
        /// </summary>
